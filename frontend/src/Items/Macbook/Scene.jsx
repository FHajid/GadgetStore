...
export default function Model(props) {
  const { nodes, materials } = useGLTF('./3D/macbook/scene.gltf')
  return (
    <group {...props} dispose={null}>
      <group position={[0, 0, -0.118]} rotation={[-1.824, 0, 0]} scale={[1, 1, 0.999]}>
        ...
        <mesh geometry={nodes.Object_23.geometry} material={materials['SVGMat.006']} />
        <mesh geometry={nodes.Object_25.geometry} material={materials['Material.009']} position={[0, 0.005, 0.122]} rotation={[-Math.PI, 0, 0]} scale={[0.166, 0.165, 0.104]} />
      </group>
