...
export default function Applewatchdetail() {
    const navigate = useNavigate();
    const [product, setProduct] = useState(null);
    const [count, setCount] = useState(1);
    const [selectedSize, setSelectedSize] = useState(null);
    const [selectedColor, setSelectedColor] = useState("");
    const [mainImgSrc, setMainImgSrc] = useState("/Picture/Item/Watch/apple_watch.jpg");

    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axios.get('http://localhost:8082/product/4');
        ...
        <div>
            ...
            <div className="detail_main">
                <div className="breadcrumb">
                    ...
                    <i id="active-link-breadcrumb"> Apple Watch S3 Detail </i>
                </div>
                ...
                <div className="product-detail">
                    <div className="left">
                        <div className="contain-left">
                            <img
                                src="/Picture/Item/Watch/apple_watch.jpg"
                                alt="Apple Watch"
                                onClick={() => handleImageClick("/Picture/Item/Watch/apple_watch.jpg")}
                            />
                            <img
                                src="/Picture/Item/Watch/apple_watch_blue.jpg"
                                alt="Apple Watch"
                                onClick={() => handleImageClick("/Picture/Item/Watch/apple_watch.jpg_blue")}
                            />
                            <img
                                src="/Picture/Item/Watch/apple_watch_cream.jpg"
                                alt="Apple watch"
                                onClick={() => handleImageClick("/Picture/Item/Watch/apple_watch_cream.jpg")}
                            />
                            <img
                                src="/Picture/Item/Watch/apple_watch_black.jpg"
                                alt="Apple watch"
                                onClick={() => handleImageClick("/Picture/Item/Watch/apple_watch_black.jpg")}
                            />
                        </div>
                    </div>
                        ...
                        <div className="container-right">
                            ...
                            <div className="contain-warna">
                                ...
                                <div className="warna-kelompok">
                                    <button
                                        className={`warna1watch ${selectedColor === "White" ? "selected" : ""}`}
                                        onClick={() => handleColorClick("White")}
                                    >
                                    </button>
                                    <button
                                        className={`warna2watch ${selectedColor === "Blue" ? "selected" : ""}`}
                                        onClick={() => handleColorClick("Blue")}
                                    >
                                    </button>
                                    <button
                                        className={`warna3watch ${selectedColor === "Cream" ? "selected" : ""}`}
                                        onClick={() => handleColorClick("Cream")}
                                    >
                                    </button>
                                    <button
                                        className={`warna4watch ${selectedColor === "Black" ? "selected" : ""}`}
